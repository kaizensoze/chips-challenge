...
// locks
tiles['blueLock'] = {name: 'blueLock', cssClass: 'blue-lock'};
tiles['redLock'] = {name: 'redLock', cssClass: 'red-lock'};
tiles['greenLock'] = {name: 'greenLock', cssClass: 'green-lock'};
tiles['yellowLock'] = {name: 'yellowLock', cssClass: 'yellow-lock'};
...
// walls
tiles['wall'] = {name: 'wall', cssClass: 'wall'};
tiles['fakeBlueWall'] = {name: 'fakeBlueWall', cssClass: 'fake-blue-wall'};
tiles['realBlueWall'] = {name: 'realBlueWall', cssClass: 'real-blue-wall'};
tiles['hiddenWall'] = {name: 'hiddenWall', cssClass: 'hidden-wall'};
tiles['invisibleWall'] = {name: 'invisibleWall', cssClass: 'invisible-wall'};
tiles['thinWallTop'] = {name: 'thinWallTop', cssClass: 'thin-wall-top'};
tiles['thinWallLeft'] = {name: 'thinWallLeft', cssClass: 'thin-wall-left'};
tiles['thinWallBottom'] = {name: 'thinWallBottom', cssClass: 'thin-wall-bottom'};
tiles['thinWallRight'] = {name: 'thinWallRight', cssClass: 'thin-wall-right'};
tiles['thinWallBottomRight'] = {name: 'thinWallBottomRight', cssClass: 'thin-wall-bottom-right'};
tiles['recessedWall'] = {name: 'recessedWall', cssClass: 'recessed-wall'};
tiles['closedToggleWall'] = {name: 'closedToggleWall', cssClass: 'closed-toggle-wall'};
tiles['openToggleWall'] = {name: 'openToggleWall', cssClass: 'open-toggle-wall'};
tiles['cloneMachine'] = {name: 'cloneMachine', cssClass: 'clone-machine'};
tiles['cloneBlockUp'] = {name: 'cloneBlockUp', cssClass: 'clone-block-up'};
tiles['cloneBlockLeft'] = {name: 'cloneBlockLeft', cssClass: 'clone-block-left'};
tiles['cloneBlockDown'] = {name: 'cloneBlockDown', cssClass: 'clone-block-down'};
tiles['cloneBlockRight'] = {name: 'cloneBlockRight', cssClass: 'clone-block-right'};
tiles['socket'] = {name: 'socket', cssClass: 'socket'};
tiles['block'] = {name: 'block', cssClass: 'block'};
...
firstLevel = {
  ...
  "levelData": [
    ...
    { "y": 4, "x": 12, "tileStack": [tiles["floor"], tiles["yellowLock"]] },
