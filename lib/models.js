...
tiles['fakeExitChipInExit'] = {name: 'fakeExitChipInExit', cssClass: 'fake-exit-chip-in-exit', types: ['exit']};
tiles['fakeExitDarkBlueBorder'] = {name: 'fakeExitDarkBlueBorder', cssClass: 'fake-exit-dark-blue-border', types: ['exit']};
tiles['fakeExitLightBlueBorder'] = {name: 'fakeExitLightBlueBorder', cssClass: 'fake-exit-light-blue-border', types: ['exit']};
